...
const AdminDelete = () => {
  ...
  useEffect(() => {
    const fetchProblems = async () => {
      try {
        setLoading(true);
        const { data } = await axiosClient.get("/api/v1/problems/getAllProblems");
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axiosClient.post(`/problems/delete/${id}`);
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-600">
                  Deleting a problem will permanently remove
                  it from the platform. This action cannot be
                  undone.
                </p>
              </div>
            </div>
